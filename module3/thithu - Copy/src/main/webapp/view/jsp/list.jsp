...
<div class="row text-center align-items-end" style="height: 10%">
    ...
    <div class="col-lg-4"><h3 class="mb-4">DANH SÁCH BỆNH NHÂN</h3>
    </div>
            ...
            <table id="tableCustomer" class="table table-striped table-hover table-bordered" style="width: 100%">
                ...
                <c:forEach var="benhAn" items="${benhAnList}" varStatus="status">
                    <tr class="text-center">
                        ...
                        <td>${benhAn.getIdBenhAn()}</td>
                        <td>${benhAn.getIdBenhNhan()}</td>
                        <td>${benhAn.getName()}</td>
                        <td>${benhAn.getNgayNhap()}</td>
                        <td>${benhAn.getNgayRa()}</td>
                        <td>${benhAn.getLyDo()}</td>

                        <td>
                            <form class="d-flex col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-3 ">
                                <button onclick="location.href='benhAn?action=edit&id=${benhAn.getIdBenhAn()}'"
                        ...
                        <td>
                            <form class="d-flex col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-3 ">
                                <button onclick="idRemove('${benhAn.getIdBenhAn()}','${benhAn.getName()}')"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="/benhAn?action=remove" method="post">
