...
<div class="vh-100 vw-100">
    <header class="d-flex justify-content-between" style="height: 15%;">
        ...
        <div class="d-flex justify-content-center pe-5">
            <button type="button" class="btn btn-success my-5 text-dark bg-light" data-bs-toggle="modal"
                    data-bs-target="#exampleModalLogin">login
            </button>
        </div>
    </header>
    ...
    <div class="row" style="height: 75%">
        <div class="col-md-12 col-lg-2 border-end">
            ...
            <div class="row">
                <div class=" col-lg-2 ">
                    <div class="mt-5 d-flex justify-content-center">
                        <button type="button" class="btn btn-outline-success">ROOM TYPE</button>
                    </div>
                    <div class="mt-5 d-flex justify-content-center">
                        <button type="button" class="btn btn-outline-success">ENTERTAIMENT</button>
                    </div>
                    <div class="mt-5 d-flex justify-content-center">
                        <button type="button" class="btn btn-outline-success">SPA</button>
                    </div>
                    <div class="mt-5 d-flex justify-content-center">
                        <button type="button" class="btn btn-outline-success">ENDOW</button>
                    </div>
                </div>
                <div class=" col-lg-8">
                    ...
                    <div class="container mt-2">
                        <h3 style="text-align: center"> KHU NGHỈ DƯỠNG FURAMA ĐÀ NẴNG </h3>
                        <div class="content">
                            <p>
                                ...
                                dự đượ
                                c đón tiếp nhiều người nổi tiếng, giới hoàng gia, chính khách, ngôi sao điện ảnh và các
                                nhà lãnh đạo kinh doanh quốc tế.Hướng ra bãi biển Đà Nẵng trải dài cát trắng, Furama
                                Resort Đà Nẵng là cửa ngõ đến với 3 di sản văn hoá thế giới: Hội An (20 phút), Mỹ Sơn
                                (90 phút) và Huế (2 tiếng. 196 phòng hạng sang cùng với 70 căn biệt thự từ hai đến bốn
                                phòng ngủ có hồ bơi riêng đều được trang trí trang nhã, theo phong cách thiết kế truyền
                                thống của Việt Nam và kiến trúc thuộc địa của Pháp, biến Furama thành khu nghỉ dưỡng
                                danh giá nhất tại Việt Nam – vinh dự đượ
                                c đón tiếp nhiều người nổi tiếng, giới hoàng gia, chính khách, ngôi sao điện ảnh và các
                                nhà lãnh đạo kinh doanh quốc tế.Hướng ra bãi biển Đà Nẵng trải dài cát trắng, Furama
                                Resort Đà Nẵng là cửa ngõ đến với 3 di sản văn hoá thế giới: Hội An (20 phút), Mỹ Sơn
                                (90 phút) và Huế (2 tiếng. 196 phòng hạng sang cùng với 70 căn biệt thự từ hai đến bốn
                ...
                <div class=" col-lg-2">
                    <div class="mt-5 d-flex justify-content-center">
                        <button type="button" class="btn btn-outline-success">START DAY</button>
                    </div>
                    <div class="mt-5 d-flex justify-content-center">
                        <button type="button" class="btn btn-outline-success">END DAY</button>
                    </div>
                    <div class="mt-5 d-flex justify-content-center">
                        <button type="button" class="btn btn-outline-success">BOOKING</button>
                    </div>
                    <div class="mt-5 d-flex justify-content-center">
                        <button type="button" class="btn btn-outline-success">SUPPORTS</button>
                    </div>
                </div>
            </div>
        </div>
...
<!-- LOGIN -->
<div class="modal fade" id="exampleModalLogin" tabindex="-1" aria-labelledby="exampleModalLabelLogin"
     aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" style="background: -webkit-linear-gradient(left, #046056, #ffffff)">
                <h5 class="modal-title text-white" id="exampleModalLabelLogin">Furama Danang</h5>
                    ...
                    <div class="container register-form">
                        <div class="form">
                            <div class="note align-items-center d-flex justify-content-center">
                                <div class="col-md-6">
                                    <button type="button" class="btn btn-outline-success my-5 text-white "
                                            data-bs-toggle="modal" data-bs-target="#exampleModalLogin"
                                            style="height: 60px;width: 170px">login
                                    </button>
                                </div>
                                <div class="col-md-6">
                                    <button type="button" class="btn btn-outline-success my-5 text-white  "
                                            data-bs-toggle="modal" data-bs-target="#exampleModalRegister"
                                            style="height: 60px;width: 170px">register
                                    </button>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control"
                                                   placeholder="Your e-mail or username *" value=""/>
                                        </div>
                                        <br>
                                        <div class="form-group">
...
<div class="modal fade" id="exampleModalRegister" tabindex="-1" aria-labelledby="exampleModalLabelRegister"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" style="background: -webkit-linear-gradient(left, #046056, #ffffff)">
                <h5 class="modal-title text-white" id="exampleModalLabelRegister">Furama Danang</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="row m-5">
...
<div class="modal fade" id="exampleModalLogOut" tabindex="-1" aria-labelledby="exampleModalLabelLogOut"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="button" class="btn btn-success" id="liveToastBtn">Keep Log-Out</button>
            </div>
        </div>
    </div>
</div>
